...
(1, 'Administrator', NULL, 'Admin', 'admin', '0192023a7bbd73250516f069df18b500', 'uploads/avatar-1.png?v=1639468007', NULL, 1, 1, '2021-01-20 14:02:37', '2021-12-14 15:47:08'),
(3, 'Jasmitha', NULL, '', 'jasmitha', 'f900a2da7cdb06b2b2803a43f5fa9538', 'uploads/avatar-3.png?v=1639467985', NULL, 2, 1, '2021-12-14 15:46:25', '2021-12-14 15:46:25');
...
CREATE PROCEDURE update_appointment_status(IN appointment_category_id INT)
BEGIN
    DECLARE category_status INT;
    SELECT delete_flag INTO category_status FROM category_list WHERE id = appointment_category_id;
    IF category_status = 0 THEN
...
DELIMITER //
CREATE TRIGGER before_insert_appointment_list
BEFORE INSERT ON appointment_list
FOR EACH ROW
BEGIN
    CALL update_appointment_status(NEW.category_id);
    SET NEW.status = @appointment_status;
END;
//
DELIMITER ;
